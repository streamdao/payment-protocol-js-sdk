...
export interface Stream {
  ...
  mint: string;
  escrowTokens: string;
  streamdaoTreasury: string;
  streamdaoTreasuryTokens: string;
  streamdaoFeeTotal: BN;
  streamdaoFeeWithdrawn: BN;
  streamdaoFeePercent: number;
  partnerFeeTotal: BN;
...
export interface DecodedStream {
  ...
  streamdaoTreasury: PublicKey;
  streamdaoTreasuryTokens: PublicKey;
  streamdaoFeeTotal: BN;
  streamdaoFeeWithdrawn: BN;
  streamdaoFeePercent: BN;
  partnerFeeTotal: BN;
  partnerFeeWithdrawn: BN;

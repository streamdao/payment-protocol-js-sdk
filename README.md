Docs: https://streamdao/payment-protocol-js-sdk/

# Stream Payment Protocol

Stream Payment is a token distribution platform powered by a streaming payments' protocol.
...
Protocol audit available [here](https://github.com/streamdao/payment-protocol-rust-sdk/blob/main/protocol_audit.pdf).

Partner oracle audit available here [here](https://github.com/streamdao/payment-protocol-rust-sdk/blob/main/partner_oracle_audit.pdf).
...
Stream Payment Protocol program ID (devnet): `7wTGkkRHnZnsgGDL4Ptp89SHWTYKcoaytFQ18ZPeyTg2`
<br>
Stream Payment Protocol program ID (mainnet): `strmRqUCoQUgGUan5YhzUZa6KqdzwX5L6FpUxfmKg5m`
...
**StreamDAO Community** (free and open source version, with a limited feature set) is available [here](https://github.com/streamdao/payments-protocol-js-sdk/tree/community).
